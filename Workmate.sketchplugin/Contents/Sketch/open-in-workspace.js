var onRun = function(context) {
  ...
  var docWSURLPage = docWSURL
  //"/p/" + getValueInParentheses(document.selectedPage.id.toString()) + "/canvas?posX="+Xpos+"&posY="+Ypos+"&zoom="+Ascale
  ...
  if (document.selectedPage.isSymbolsPage()){
    openUrl(docWSURLPage+"/symbols")
  } else {
